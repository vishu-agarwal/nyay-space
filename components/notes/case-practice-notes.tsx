...
export function CasePracticeNotes({
  ...
  const notes = useEntityPracticeNotes("case", entityId);
  ...
  const handleAdd = useCallback(() => {
    const t = draft.trim();
    if (!t) return;
    addPracticeNote("case", entityId, t);
    setDraft("");
  }, [draft, entityId]);
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <AppModal
        ...
        title="Case notes"
        description="Private notes for this case. Saved only in this browser for now."
      >
        <div>
