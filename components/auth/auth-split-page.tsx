...
export function AuthSplitPage({
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-4 lg:grid lg:min-h-0 lg:grid-cols-[1.05fr_minmax(0,440px)] lg:items-stretch lg:gap-7 xl:gap-10">
      ...
      <div className="order-1 flex flex-col justify-center lg:order-2 lg:py-2">
        <div className="mb-3 flex justify-center lg:mb-4 lg:justify-start">
          <NyayLogoLink
            href={logoHref}
